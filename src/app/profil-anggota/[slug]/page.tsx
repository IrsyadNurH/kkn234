...
// Ini akan memberitahu Next.js semua `slug` yang harus dibuat statis di build time.
...
// Tetap sync karena datanya lokal, tidak masalah.
...
// ✅ WAJIB: Buat fungsi komponen menjadi `async` supaya cocok dengan App Router & SSG.
