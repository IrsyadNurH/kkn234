...
export type Anggota = {
  id: string; // ID unik untuk scrolling
  nama: string;
  jabatan?: string;
  divisi: string;
  jurusan: string;
...
export const dataDivisi: Divisi[] = [
  {
    ...
    anggota: [
      { 
        ...
        social: { instagram: 'https://instagram.com/arikwibisono' }
      },
      { 
        id: 'aulia-nuha',
        ...
        profilePicture: '/images/anggota/profil/aulia-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/aulianuha' }
      },
      { 
        id: 'yutrie-herlambang',
        nama: 'Yutrie Annisa Herlambang', 
        jabatan: 'Bendahara',
        divisi: 'Struktur Inti',
        jurusan: 'Pendidikan Islam Anak Usia Dini', 
        imageUrl: '/images/anggota/yutrie.jpg',
        profilePicture: '/images/anggota/profil/yutrie-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/yutrieannisa' }
      },
    ],
  },
  {
    ...
    anggota: [
      { 
        ...
        profilePicture: '/images/anggota/profil/saniyyah-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/saniyyahbarkah' }
      },
      { 
        id: 'puspa-ningrum',
        ...
        profilePicture: '/images/anggota/profil/puspa-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/puspaningrum' }
      },
      { 
        id: 'miftah-sidiq',
        ...
        profilePicture: '/images/anggota/profil/miftah-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/miftahsidiq' }
      },
    ],
  },
  {
    ...
    anggota: [
      { 
        ...
        profilePicture: '/images/anggota/profil/irsyad-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/irsyadnur' }
      },
      { 
        id: 'muhammad-ridho',
        ...
        profilePicture: '/images/anggota/profil/ridho-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/ridhomujahid' }
      },
      { 
        id: 'aditya-novrizal',
        ...
        profilePicture: '/images/anggota/profil/aditya-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/adityanovrizal' }
      },
    ],
  },
  {
    ...
    anggota: [
      { 
        ...
        profilePicture: '/images/anggota/profil/agil-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/agilsapik' }
      },
      { 
        id: 'syifa-azzahra',
        nama: 'Syifa Azzahra', 
        ...
        profilePicture: '/images/anggota/profil/syifa-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/syifaazzahra' }
      },
      { 
        id: 'witria-yuliana',
        nama: 'Witria Yuliana', 
        ...
        profilePicture: '/images/anggota/profil/witria-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/witria_yuliana' }
      },
    ],
  },
  {
    ...
    anggota: [
      { 
        ...
        profilePicture: '/images/anggota/profil/windy-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/nokwindy' }
      },
      { 
        id: 'rosalinda',
        nama: 'Rosalinda', 
        ...
        profilePicture: '/images/anggota/profil/rosalinda-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/rosalinda' }
      },
      { 
        id: 'nurjanah-azzahra',
        ...
        profilePicture: '/images/anggota/profil/nurjanah-besar.jpg',
        ...
        social: { instagram: 'https://instagram.com/nurjanahazzahra' }
      },
    ],
  },
];
